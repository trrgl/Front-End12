    ...
    return (
        <div className="bg-black text-white min-h-screen">
            ...
            <div className="px-20 space-y-4">
                ...
                <h1>2. Олсон sub_401909 дээр байгаа function нь byte_4A1100 дээр байгаа дата-г 0x25-аар XOR-дож байгаа буцаан XOR-доод гарсан утгын програмлуугаа оруулна.</h1>
